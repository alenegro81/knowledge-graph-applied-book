...
from document_selector_re import REDiarySelectorTool
...
if __name__ == "__main__":
    ...
    tools = [
        Tool(
            ...
            Not useful for questions that can be answered by querying the KnowledgeGraph or EntityRelationDiarySelector tool.
            Use this tool as a backup approach if the other tools say that they do not know the answer or don't have specific information.
        ...
        Tool(
            ...
            description=f"""Useful when you need to answer questions about how are entities such as people, 
    ...
    #question = "Who are the top influencers of cyclotron?"# and what is known about them?"
    question = "What did August Krogh say about Lawrence Irving?"
